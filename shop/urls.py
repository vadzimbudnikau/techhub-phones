...
urlpatterns = [
    ...
    path('product-catalog/', views.ProductCatalogView.as_view(), name='product_catalog'),
    ...
    path('accounts/profile/update', views.UserProfileUpdateView.as_view(), name='profile_update'),
